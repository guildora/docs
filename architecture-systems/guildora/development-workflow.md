...
- landing content is fetched from Hub's `/api/public/landing` endpoint — it is DB-backed and managed via the Hub landing editor
...
- internal buttons must remain design-system-aligned
