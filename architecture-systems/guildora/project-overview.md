...
Guildora is a Discord-centered community platform in a pnpm monorepo. It combines a public landing page, an internal member hub, a Discord bot, and a shared PostgreSQL-backed domain model.
...
The hub is the operational center for members, moderation, admin tooling, landing page management, and internal APIs. The landing app is public-facing. The bot keeps Discord state and app state connected.
...
- admins and superadmins who manage theme settings, community settings, Discord role mappings, installed apps, landing page content, and mirror flows
- AI agents and developers who need a grounded model of the repository

## Main Use Cases

- public landing-page rendering from DB-backed content managed in Hub
...
- the MCP server (`packages/mcp-server`) provides AI-driven landing page editing via Hub API
...
apps/
  ...
  hub/          Nuxt 4 internal app + Nitro API + Discord OAuth + landing editor
...
packages/
  ...
  mcp-server/   MCP server for AI-driven landing page editing
