# Overview: What are Guildora Apps?
...
├── README.md
├── AGENTS.md              ← AI agent guidance (optional but recommended)
└── src/
    ├── pages/             ← Vue components rendered in the Hub
    ├── api/               ← Nitro server-side API handlers
    ├── bot/
